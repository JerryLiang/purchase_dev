 ...
 * @DateTime 2019/1/21
 */
class Supplier_product_line_model extends Api_base_model
{
...
//    protected $_actionLogUrl; // 操作日志
    ...
    /**
     * @desc 获取下拉级别列表（one:一级，tow:二级，third：三级）
     * @author jackson
     * @parames array $params 请求参数
     * @Date 2019-01-21 15:26:00
     * @return array()
     */
    public function get_product_line($params = array())
    {
        ...
        $data = $result['data'];
        $records = $data['list'];
        $levelFields = 'product_line_id';

        $records = create_key_and_name($records, $levelFields, 'linelist_cn_name');
