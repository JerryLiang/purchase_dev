 ...
 */
class Print_pdf_model extends Api_base_model {
...
//       $pdf->setLanguageArray("xx");
 ...
 字体类型（如helvetica(Helvetica)黑体，times (Times-Roman)罗马字体）、风格（B粗体，I斜体，underline下划线等）、字体大小 */
    ...
    public static function writePdf($content, $title = '', $fileName, $type = 'D', $file_css = '',$print_type='A4',$footer =''){
       // var_dump(dirname(APPPATH).'/webfront/'."third_party/mpdf/mpdf.php");exit;
        //require_once dirname(APPPATH).'/webfront/'."third_party/mpdf/mpdf.php";
        ...
        if(empty($file_css)){
            ...
            $css1 = VIEWPATH_PRINT_TEMPLATE."print_template/mycss/".$file_css;
        }
