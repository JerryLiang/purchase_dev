...
//       pr($this->search_params);exit;
    ...
    {
        $param = [
            "page" => isset($params["offset"]) ? (int)$params["offset"]: 1,
            "per_page" => isset($params["limit"]) ? (int)$params["limit"]: self::$_default_persize,
        ];
        //规则定义
        ...
        //page control
        $format_params['per_page'] = isset($param["per_page"])? (int)$param["per_page"]: self::$_default_persize;
        $format_params['page'] = isset($param["page"]) ? (int)$param["page"]: 1;
