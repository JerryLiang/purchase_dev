 ...
 * @author:Dean
 **/
class Purchase_shipping_report_loss extends MY_Controller{

    public function __construct()
    {
        parent::__construct();

       $this->load->model('purchase_shipping_report_loss_model');
    }
    //报损信息
    public function report_loss_list()
    {
        ...
        $result=$this->purchase_shipping_report_loss_model->get_report_loss_list($params,$page_data['offset'],$page_data['limit'],$page_data['page']);
    ...
    public function get_export_report_loss_data(){
        ...
        $result=$this->purchase_shipping_report_loss_model->get_report_loss_list($params);
